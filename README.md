...
<p align="center">
  <strong>Kling API access for AI agents: run video generation operations, poll asynchronous results, and check pricing through one focused MCP server.</strong>
</p>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Models-15-16a34a?style=flat-square" alt="15 models">
</p>
...
It gives MCP-compatible assistants direct access to 5 endpoints and 15 model variants without loading the full RunAPI catalog.
...
Kling covers 15 model variants across 5 endpoints. Each tool accepts the models listed for it:
...
| `image_to_video` | `kling-v2.1-master-image-to-video`, `kling-v2.1-pro`, `kling-v2.1-standard`, `kling-v2.5-turbo-image-to-video-pro`, `kling-v2.6`, `kling-v3-omni`, `kling-v3-turbo-image-to-video` |
| `motion_control` | `kling-3.0`, `kling-v2.6` |
| `text_to_video` | `kling-3.0`, `kling-v2.1-master-text-to-video`, `kling-v2.5-turbo-text-to-video-pro`, `kling-v2.6`, `kling-v3-omni`, `kling-v3-turbo-text-to-video` |
